...
# plt.figure()
# plt.loglog(g_data,func_mag(g_data,5e-7), '--', label=r'$B_0=5 \times 10^{-7}$ T')
# plt.loglog(g_data,func_mag(g_data,5e-6), '--', label=r'$B_0=5 \times 10^{-6}$ T')
# plt.loglog(g_data,func_mag(g_data,5e-5), '--', label=r'$B_0=5 \times 10^{-5}$ T')
# plt.loglog(g_data,func_mag(g_data,5e-4), '--', label=r'$B_0=5 \times 10^{-4}$ T')
# plt.loglog(g_data,func_mag(g_data,5e-3), '--', label=r'$B_0=5 \times 10^{-3}$ T')
# plt.axvline(x = 0.144/9.81 , color = 'b', linestyle='-.')#, label = '')
# plt.annotate(xy=[0.2/9.81, 3e-7], s='Psyche')
...
plt.figure()
plt.loglog(g_data,func_rho(g_data,1000), '--', label=r'$\rho= 1\ g\ cm^{-3}$')
plt.loglog(g_data,func_rho(g_data,3000), '--', label=r'$\rho= 3\ g\ cm^{-3}$')
plt.loglog(g_data,func_rho(g_data,5000), '--', label=r'$\rho= 5\ g\ cm^{-3}$')
plt.loglog(g_data,func_rho(g_data,7000), '--', label=r'$\rho= 7\ g\ cm^{-3}$')
plt.loglog(g_data,func_rho(g_data,9000), '--', label=r'$\rho= 9\ g\ cm^{-3}$')
plt.axvline(x = 0.144/9.81 , color = 'b', linestyle='-.')#, label = '')
plt.annotate(xy=[0.2/9.81, 3e-7], s='Psyche')
...
tpl.save("/home/aerospacenerd/Research/Planetary_Science_Journal/Tikz/test_ag.tex")
plt.show()